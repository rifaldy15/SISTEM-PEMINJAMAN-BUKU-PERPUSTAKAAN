...
@section('content')
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-500 dark:text-gray-400">Tambah kategori baru untuk koleksi buku</p>
        </div>
    ...
    <div class="max-w-4xl">
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-800">
                <h3 class="font-semibold text-gray-800 dark:text-white">Formulir Kategori Baru</h3>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                            ...
                            placeholder="Tulis deskripsi singkat kategori buku ini...">{{ old('description') }}</textarea>
