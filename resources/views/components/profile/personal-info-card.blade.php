        ...
        <div class="w-full">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <button @click="$dispatch('open-profile-info-modal')"
                    class="flex items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                ...
                <div>
                    <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Nomor Telepon</p>
                ...
                <div class="px-2 overflow-y-auto custom-scrollbar">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                        ...
                        <div class="col-span-1 lg:col-span-2">
                            ...
                            <x-form.form-elements.dropzone name="photo" accept="image/png,image/jpeg,image/webp" label="Update Foto Profil" />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="email" name="emailAddress" value="{{ Auth::user()->email }}"
                                class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                        </div>
