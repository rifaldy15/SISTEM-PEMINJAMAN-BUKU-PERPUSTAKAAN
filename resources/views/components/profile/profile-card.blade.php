<div x-data="{saveProfile(){
                ...
                <div class="order-3 xl:order-2">
                    ...
                    <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            {{ Auth::user()->bio ?? 'Web Developer' }}
                        </p>
                        <div class="hidden h-3.5 w-px bg-gray-300 xl:block dark:bg-gray-700"></div>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            {{ Auth::user()->city && Auth::user()->country ? Auth::user()->city . ', ' . Auth::user()->country : 'Jakarta, Indonesia' }}
                        </p>
                    </div>
                </div>
    ...
    <!-- Profile Info Modal removed to avoid duplication with Personal Info Card -->
</div>
